...
const defaults = {
  ...
  HOST: 'https://pr-roan.vercel.app/', // Host interface to bind server to
  ...
  CUSTOM_SETTINGS_HOSTNAME: 'https://pr-roan.vercel.app/', // Hostname to send different config settings to client
